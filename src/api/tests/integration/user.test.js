...
describe('Users API', async () => {
  ...
  describe('GET /v2/users/:userId', () => {
    ...
    it('should report error "User does not exist" when user does not exists', () => {
      return request(app)
        .get('/v2/users/56c787ccc67fc16ccc1a5e92')
        .set('Authorization', `Bearer ${adminAccessToken}`)
