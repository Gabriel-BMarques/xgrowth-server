...
const BusinessUnit = require('../models/businessUnit.model');
...
exports.create = async (req, res, next) => {
  try {
    const entity = new BusinessUnit(req.body);
...
exports.get = async (req, res, next) => {
  try {
    const entity = await BusinessUnit.findById(req.params.id);
...
exports.list = async (req, res, next) => {
  try {
    ...
    const entities = await BusinessUnit.find(query);
...
exports.update = async (req, res, next) => {
  try {
    ...
    const oldEntity = await BusinessUnit.findById(entity._id);
    ...
    let savedEntity = await BusinessUnit.findById(entity._id);
